...
function Body(){
  return (
        <div className="services">
            ...
            <p>RDX Building Services, an environment friendly cleaning company is committed to providing an exceptional service, that’s reliable and consistent. Our goal is to form long lasting relationships with our customers offering great value to their businesses and unparalleled customer service.</p>
