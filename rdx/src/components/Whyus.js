...
function Whyus() {
  return (
    <div className="whyus">
      <a name="whyus">
        <h2 className="whyusTitle">ARE YOU READY TO EXPERIENCE CLEAN?</h2>
      </a>
